...
- Added a **“Use Polling to Watch for File Changes”** option under _Local List Settings_, to address issues reading from mounted remote drives ([#142](https://github.com/any-listen/any-listen/issues/142)).
