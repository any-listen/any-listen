<script lang="ts">
  ...
  const lyricUnplayColor = colorPick(
    settingState.setting['desktopLyric.style.lyricUnplayColor'],
    [
      'rgba(255, 255, 255, 1)',
      'rgba(255, 236, 144, 1)',
      'rgba(144, 255, 206, 1)',
    ...
    (val) => {
      void updateSetting({ 'desktopLyric.style.lyricUnplayColor': val })
    }
  )
  const lyricPlayedColor = colorPick(
    settingState.setting['desktopLyric.style.lyricPlayedColor'],
    [
      'rgba(255, 236, 144, 1)',
      'rgba(144, 255, 206, 1)',
      'rgba(32, 255, 132, 1)',
    ...
    (val) => {
      void updateSetting({ 'desktopLyric.style.lyricPlayedColor': val })
    }
  )
  const lyricShadowColor = colorPick(
    settingState.setting['desktopLyric.style.lyricShadowColor'],
    [
      'rgba(0, 0, 0, 0.6)',
      //  'rgba(0, 0, 0, 0.15)'
    ],
    (val) => {
      void updateSetting({ 'desktopLyric.style.lyricShadowColor': val })
    }
  )
  ...
  const resetColor = () => {
    ...
    lyricUnplayColor.setColor(defaultSetting['desktopLyric.style.lyricUnplayColor'])
    lyricPlayedColor.setColor(defaultSetting['desktopLyric.style.lyricPlayedColor'])
    lyricShadowColor.setColor(defaultSetting['desktopLyric.style.lyricShadowColor'])
  }
  ...
  onMount(() => {
    lyricUnplayColor.setColor(settingState.setting['desktopLyric.style.lyricUnplayColor'])
    lyricPlayedColor.setColor(settingState.setting['desktopLyric.style.lyricPlayedColor'])
    lyricShadowColor.setColor(settingState.setting['desktopLyric.style.lyricShadowColor'])
  })
</script>
